                    ...
                    <div className="col-lg-4 col-md-12">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <div className="net-income mt-4 position-relative" style={{ height: '294px' }} />
                        ...
                        <div className="card">
                            <div className="card-body">
                                    ...
                                    <div className="ml-auto">
                                        <div className="dropdown sub-dropdown">
                                            ...
                                            <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dd1">
                                                <a className="dropdown-item"  >Insert</a>
                                ...
                                <div className="pl-4 mb-5">
                                    <div className="stats ct-charts position-relative" style={{ height: '315px' }} />
                                </div>
                            ...
                            <div className="card-body">
                                ...
                                <div className="mt-4 activity">
                                    <div className="d-flex align-items-start border-left-line pb-3">
                                        <div>
                                            <a className="btn btn-info btn-circle mb-2 btn-item">
